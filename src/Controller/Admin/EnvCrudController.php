 ...
 * 环境变量管理控制器
 *
 * @extends AbstractCrudController<Env>
 */
#[AdminCrud(routePath: '/env-manage/env', routeName: 'env_manage_env')]
final class EnvCrudController extends AbstractCrudController
{
    ...
    public function copyEnv(AdminContext $context): Response
    {
        ...
        $newEnv->setRemark(null !== $env->getRemark() ? $env->getRemark() . ' (复制)' : '');
